...
"}")
        ...
        self.pushButton_7.setStyleSheet("border-radius: 3px;\n"
"padding: 10px;\n"
"color: black;\n"
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0.409, stop:0 rgba(255, 241, 0, 255), stop:0.517241 rgba(74, 255, 0, 255), stop:1 rgba(0, 232, 255, 255));")
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 750, 223))
...
"}")
        ...
        self.checkBox.setBaseSize(QtCore.QSize(50, 50))
...
"}")
        ...
        self.label_6 = QtWidgets.QLabel(self.data_page)
...
"LOGIN QILIB CHIQISH"))
        ...
        self.checkBox.setText(_translate("MainWindow", "Boynazarov Bexruz Xayrulla o\'g\'li"))
        self.label_6.setText(_translate("MainWindow", "2 ta o\'quvchi belgilandi"))
        self.pushButton_4.setText(_translate("MainWindow", "O\'chirish"))
        self.pushButton_3.setText(_translate("MainWindow", "Yangi o\'quvchi"))
